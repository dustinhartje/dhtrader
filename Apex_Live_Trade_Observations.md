...
The following trades were performed in Apex evaluation accounts to capture true results for use in unit testing.  The drawdown distance and account balance were captured for each trade as well as a few other details to confirm how the fees and drawdowns are calculated
